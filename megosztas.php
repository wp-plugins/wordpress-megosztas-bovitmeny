...
Description: Ezzel a bővítménnyel számos látogatót szerezhetünk weboldalunkra a Magyar és külföldi közösségi médiák segítségével.
Version: 2.0
...
function kwm_css(){
	echo '<link rel="stylesheet" type="text/css" href="' . get_option('siteurl') .'/wp-content/plugins/wordpress-megosztas-bovitmeny/css/stilus.css" />',"\r\n";
}
...
function kwm_megosztas( $content ) {
  ...
  // Facebook
	$html .= '<a target="_blank" class="facebook" title="'.$options['fb_felirat'].'" rel="external" href="http://www.facebook.com/share.php?u=' . $bejegyzes_link . '"></a>';
  // Twitter
	$html .= '<a target="_blank" class="twitter" title="'.$options['tw_felirat'].'" rel="external" href="http://twitter.com/share?text='.$bejegyzes_nev.'&url='.$bejegyzes_link.'"></a>';
  // IWIW
	$html .= '<a target="_blank" class="iwiw" title="'.$options['iwiw_felirat'].'" rel="external" href="http://iwiw.hu/pages/share/share.jsp?u='.$bejegyzes_link.'"></a>';  
  // Startlap
  ...
  // Citromail
	$html .= '<a target="_blank" class="citromail" title="'.$options['cmail_felirat'].'" rel="external" href="http://citromail.hu/share/?url='.$bejegyzes_link.'"></a>';
  // Tumblr
  ...
  // So.cl
        $html .= '<a target="_blank" class="socl" title="'.$options['socl_felirat'].'" rel="extrenal" href="http://www.so.cl/#/search?v=results&bk=1.0&q='.$bejegyzes_link.'"></a>';
  // RSS Hírcsatorna
