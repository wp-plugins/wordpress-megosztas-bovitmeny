...
Donate link: http://www.kardiweb.org/donate/
Tags: megosztas, megosztás, share, facebook, twitter, linkedin, startlap, tumblr, google+, google plus, google plus one, email, e-mail, print, nyomtatás, rss, rss feed
...
== Description ==
 ...
 [Támogató Fórum](http://wordpress.org/support/plugin/wordpress-megosztas-bovitmeny) | [Github fejlesztés](https://github.com/KardiWeb/WordPress-Megosztas-Bovitmeny/) | [Kérdések](https://github.com/KardiWeb/WordPress-Megosztas-Bovitmeny/issues) | [Laszlo Espadas](http://www.kardiweb.org/)
...
= 2.3 =
* WordPress 4.0 kompatibilitás
* LinkedIn bevezetése
* Forráskód optimalizálás
* Felkészülés a 3.0 verzió fejlesztésére

= 2.2 =
* WordPress 3.9 kompatibilitás
* Nem definált változó javítás
* Admin oldalsáv linkek módosítása

= 2.1.1 =
* Felkerült a githubra is a bővítmény
* Hover effekt hozzáadása a stíluslaphoz
* Humans.txt fájl javítása
* WordPress 3.8.1 kompatibilitás
* WordPress verzió ellenőrzés verzió beállítása 3.5 verezióra
